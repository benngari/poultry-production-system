...
const NAV_ITEMS = [
  ...
  { to: '/feed-ingredients', label: 'Feed Ingredients', roles: null },
  { to: '/feed-batches', label: 'Feed Batches', roles: null },
  { to: '/egg-log', label: 'Egg Log', roles: null },
  { to: '/daily-egg-stock', label: 'Daily Egg Stock', roles: null },
  { to: '/flock', label: 'Flock', roles: null },
  { to: '/bird-sales', label: 'Bird Sales', roles: null },
  ...
  { to: '/audit-log', label: 'Audit Log', roles: ['Administrator'] },
  { to: '/trash', label: 'Trash', roles: ['Administrator'] },
];
